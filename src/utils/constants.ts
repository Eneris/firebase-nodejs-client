...
export const DEFAULT_BUNDLE_ID = 'receiver.push.com'
export const DEFAULT_CHROME_ID = 'org.chromium.linux'
export const DEFAULT_CHROME_PLATFORM = ChromeBuildProtoPlatform.PLATFORM_LINUX
export const DEFAULT_CHROME_CHANNEL = ChromeBuildProtoChannel.CHANNEL_STABLE
export const DEFAULT_CHROME_VERSION = '148.0.7778.271'
...
export const FCM_REGISTRATION_API = 'https://fcmregistrations.googleapis.com/v1/'